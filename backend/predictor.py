...
_RAW = {
    'loop':  {'O+':0.37,'O-':0.07,'A+':0.28,'A-':0.05,'B+':0.14,'B-':0.03,'AB+':0.04,'AB-':0.02},
    'whorl': {'O+':0.22,'O-':0.05,'A+':0.20,'A-':0.04,'B+':0.25,'B-':0.06,'AB+':0.13,'AB-':0.05},
    'arch':  {'O+':0.35,'O-':0.08,'A+':0.25,'A-':0.06,'B+':0.15,'B-':0.04,'AB+':0.05,'AB-':0.02},
}
